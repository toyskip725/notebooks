...
$$
\begin{align}
\pi_{1} \langle M, N \rangle \quad &\leadsto \quad M \tag{$\beta_{\times}$} \\
...
$$
\begin{align}
\langle \pi_{1}M, \pi_{2}M \rangle \quad \leadsto \quad M \tag{$\eta_{\times}$}
\end{align}
$$
</Definition>
...
$$
\begin{align}
\textsf{ case } \textsf{in}_{1}M \textsf{ of } x \Rightarrow N \mid y \Rightarrow L \quad &\leadsto \quad N[x:=M] \tag{$\beta_{+}$}  \\
